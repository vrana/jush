	...
	*/
	...
	highlight_states: function (states, text, in_php, escape) {
		if (!this.regexps) {
			...
			var num = /(?:0[xX][0-9a-fA-F]+)|(?:\b[0-9]+\.?[0-9]*|\.[0-9]+)(?:[eE][+-]?[0-9]+)?/;
