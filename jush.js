...
(function () {
	...
	jush.urls.http = ['http://www.w3.org/Protocols/rfc2616/rfc2616-$key',
		...
		'http://en.wikipedia.org/wiki/$1', 'http://msdn.microsoft.com/library/cc288472.aspx#_replace', 'http://msdn.microsoft.com/en-us/library/dd565640.aspx', 'http://msdn.microsoft.com/library/cc817574.aspx', 'http://en.wikipedia.org/wiki/X-Requested-With', 'http://noarchive.net/xrobots/', 'http://www.w3.org/TR/CSP/#$1-header-field'
	];
...
jush.links.sql_sqlset = { 'set-option.html': /.+/ };
